...
public class DaDataAddressSwagConverter implements SwagConverter<DaDataAddress, Address> {
    ...
    private AddressAreaData convertAddressAreaData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressAreaData addressAreaData) {
    ...
    private AddressBlockData convertAddressBlock(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressBlockData addressBlockData) {
    ...
    private AddressCityData convertAddressCityData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressCityData addressCityData) {
    ...
    private AddressCityDistrictData convertAddressCityDistrictData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressCityDistrictData addressCityDistrictData) {
    ...
    private AddressFlatData convertAddressFlatData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressFlatData addressFlatData) {
    ...
    private AddressHouseData convertAddressHouseData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressHouseData addressHouseData) {
    ...
    private AddressRegionData convertAddressRegionData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressRegionData addressRegionData) {
    ...
    private AddressSettlementData convertAddressSettlementData(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressSettlementData addressSettlementData) {
