...
public class EgrDetailsHistorySwagConverter implements
        SwagConverter<EgrDetailsHistory, dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsHistory> {

    @Override
    public EgrDetailsHistory toSwag(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsHistory value,
