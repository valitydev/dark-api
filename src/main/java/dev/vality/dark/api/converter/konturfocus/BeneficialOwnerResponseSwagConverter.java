...
public class BeneficialOwnerResponseSwagConverter implements
        SwagConverter<BeneficialOwnerResponse, dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerResponse> {

    @Override
    public BeneficialOwnerResponse toSwag(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerResponse value,
