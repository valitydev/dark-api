...
import dev.vality.swag.questionary_aggr_proxy.model.Activity;
import dev.vality.swag.questionary_aggr_proxy.model.ComplementaryActivity;
import dev.vality.swag.questionary_aggr_proxy.model.PrincipalActivity;
...
public class ActivitySwagConverter
        implements SwagConverter<Activity, dev.vality.questionary_proxy_aggr.base_kontur_focus.Activity> {

    @Override
    public Activity toSwag(dev.vality.questionary_proxy_aggr.base_kontur_focus.Activity value,
    ...
    private PrincipalActivity convertPrincipalActivity(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.PrincipalActivity principalActivity) {
