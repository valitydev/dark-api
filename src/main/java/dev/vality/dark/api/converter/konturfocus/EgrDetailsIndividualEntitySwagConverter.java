...
public class EgrDetailsIndividualEntitySwagConverter implements
        SwagConverter<EgrDetailsIndividualEntity, dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsIndividualEntity> {

    @Override
    public EgrDetailsIndividualEntity toSwag(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsIndividualEntity value,
