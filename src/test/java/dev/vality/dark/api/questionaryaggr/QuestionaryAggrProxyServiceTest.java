package dev.vality.dark.api.questionaryaggr;

import dev.vality.damsel.questionary_proxy_aggr.QuestionaryAggrProxyHandlerSrv;
import dev.vality.dark.api.questionaryaggr.utils.DaDataCompareUtil;
import dev.vality.dark.api.questionaryaggr.utils.KonturFocusCompareUtil;
import dev.vality.dark.api.service.QuestionaryAggrProxyService;
import dev.vality.dark.api.utils.QuestionaryAggrTestData;
...
import static dev.vality.swag.questionary_aggr_proxy.model.DaDataRequest.DaDataRequestTypeEnum;
import static dev.vality.swag.questionary_aggr_proxy.model.KonturFocusRequest.KonturFocusRequestTypeEnum;
...
public class QuestionaryAggrProxyServiceTest {
    ...
    public void requestKonturFocusReqQueryTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftKonturFocusReqResponse.getReqResponses().getReqResponses().size(); i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_req.ReqResponse reqResponse =
    ...
    public void requestKonturFocusLicensesTest() throws IOException, TException {
        ...
        for (int i = 0; i < thriftLicensesSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_licences.LicencesResponse licencesResponse =
    ...
    public void requestKonturFocusBeneficialOwnersTest() throws IOException, TException {
        ...
        for (int i = 0; i < thriftBeneficialOwnersSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerResponse
    ...
    public void requestDaDataPartyTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftSuggestionsSize; i++) {
            dev.vality.questionary_proxy_aggr.dadata_party.PartyContent partyContent =
    ...
    public void requestDaDataOkvedTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftSuggestionsSize; i++) {
            dev.vality.questionary_proxy_aggr.dadata_okved2.OkvedContent okvedContent =
    ...
    public void requestDaDataBankTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftSuggestionsSize; i++) {
            dev.vality.questionary_proxy_aggr.dadata_bank.BankContent bankContent =
    ...
    public void requestDaDataFioTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftSuggestionsSize; i++) {
            dev.vality.questionary_proxy_aggr.dadata_fio.FioContent fioContent =
    ...
    public void requestDaDataFmsUnitTest() throws TException, IOException {
        ...
        for (int i = 0; i < thriftSuggestionsSize; i++) {
            dev.vality.questionary_proxy_aggr.dadata_fms_unit.FmsUnitContent fmsUnitContent =
