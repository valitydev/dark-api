package dev.vality.dark.api.questionaryaggr.utils;
...
import dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolderUL;
...
public class KonturFocusCompareUtil {
    ...
    public static void licencesCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_licences.LicencesResponse thriftLicencesResponse,
    ...
    public static void egrDetailsCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsResponse thriftEgrDetailsResponse,
        ...
        if (thriftEgrDetailsResponse.getContractor().isSetIndividualEntity()) {
            ...
            for (int i = 0; i < thriftIndividualEntity.getEgrRecords().size(); i++) {
                dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrRecord egrRecord =
            ...
            for (int i = 0; i < thriftLegalEntity.getPredecessors().size(); i++) {
                dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.Predecessor predecessor =
            ...
            for (int i = 0; i < thriftLegalEntity.getShareholders().getShareholdersOther().size(); i++) {
                dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolderOther shareHolderOther =
            ...
            for (int i = 0; i < thriftLegalEntity.getShareholders().getShareholdersFl().size(); i++) {
                dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolderFl shareHolderFL =
            ...
            for (int i = 0; i < thriftLegalEntity.getFoundersForeign().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.FounderForeign founderForeign =
    ...
    private static void egrDetailsHistoryCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrDetailsHistory thriftEgrDetailsHistory,
    ...
    private static void founderForeignCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.FounderForeign thriftFounderForeign,
    ...
    private static void shareCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.Share thriftShare,
                                     Share swagShare) {
    ...
    private static void shareHolderFlCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolderFl thriftShareHolderFL,
    ...
    private static void shareHolderOtherCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolderOther thriftShareHolderOther,
    ...
    private static void successorCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.Successor thriftSuccessor,
    ...
    private static void predecessorCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.Predecessor thriftPredecessor,
    ...
    private static void regInfoCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.RegInfo thriftRegInfo,
                                       RegInfo swagRegInfo) {
    ...
    private static void regBodyCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.RegBody thriftRegBody,
                                       RegBody swagRegBody) {
    ...
    private static void nalogRegBodyCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.NalogRegBody thriftNalogRegBody,
    ...
    private static void shortenedAddressCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShortenedAddress thriftShortenedAddress,
    ...
    private static void activitiesCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.Activity thriftActivity,
        ...
        for (int i = 0; i < thriftActivity.getComplementaryActivities().size(); i++) {
            dev.vality.questionary_proxy_aggr.base_kontur_focus.ComplementaryActivity complementaryActivity =
    ...
    private static void egrRecordCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.EgrRecord thriftEgrRecord,
    ...
    public static void reqResponseCompare(ReqResponse thriftReqResponse,
                                          dev.vality.swag.questionary_aggr_proxy.model.ReqResponse swagReqResponse) {
        ...
        if (thriftReqResponse.getPrivateEntity().isSetIndividualEntity()) {
            ...
            for (int i = 0; i < swagReqLegalEntity.getBranches().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.Branch branch =
            ...
            for (int i = 0; i < swagReqLegalEntity.getHeads().size(); i++) {
                ...
                dev.vality.questionary_proxy_aggr.base_kontur_focus.Head head = reqLegalEntity.getHeads().get(i);
            ...
            for (int i = 0; i < reqLegalEntity.getManagementCompanies().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.ManagementCompany managementCompany =
            ...
            for (int i = 0; i < reqLegalEntity.getHistory().getLegalAddresses().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.LegalAddress legalAddress =
            ...
            for (int i = 0; i < reqLegalEntity.getHistory().getLegalNames().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.LegalName legalName =
            ...
            for (int i = 0; i < reqLegalEntity.getHistory().getKpps().size(); i++) {
                dev.vality.questionary_proxy_aggr.kontur_focus_req.ReqKppHistory reqKppHistory =
            ...
            for (int i = 0; i < reqLegalEntity.getHistory().getHeads().size(); i++) {
                dev.vality.questionary_proxy_aggr.base_kontur_focus.Head head =
    ...
    public static void beneficialOwnerResponseCompare(BeneficialOwnerResponse thriftBeneficialOwnerResponse,
                                                      dev.vality.swag.questionary_aggr_proxy.model.BeneficialOwnerResponse swagBeneficialOwnerResponse) {
    ...
    private static void beneficialOwnerCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwners thriftBeneficialOwners,
        ...
        for (int i = 0; i < thriftBeneficialOwnersUlSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerUl
        ...
        for (int i = 0; i < thriftBeneficialOwnersFlSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerFl
        ...
        for (int i = 0; i < thriftBeneficialOwnersOtherSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerOther
        ...
        for (int i = 0; i < thriftBeneficialOwnersForeignSize; i++) {
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerForeign
    ...
    private static void branchCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.Branch thriftBranch,
                                      Branch swagBranch) {
    ...
    private static void addressRFCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.ParsedAddressRF thriftParsedAddressRF,
    ...
    private static void toponimCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.Toponim thriftToponim,
                                       Toponim swagToponim) {
    ...
    private static void headCompare(dev.vality.questionary_proxy_aggr.base_kontur_focus.Head thriftHead,
                                    Head swagHead) {
    ...
    private static void managementCompanyCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.ManagementCompany thriftManagementCompany,
            ManagementCompany swagManagementCompany) {
    ...
    private static void legalNameCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.LegalName thriftLegalName, LegalName swagLegalName) {
    ...
    private static void legalAddressCompare(
            dev.vality.questionary_proxy_aggr.base_kontur_focus.LegalAddress thriftLegalAddress,
    ...
    private static void kppsNameCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_req.ReqKppHistory thriftReqKppHistory,
    ...
    private static void beneficialOwnerUlCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerUl thriftBeneficialOwnerUl,
    ...
    private static void beneficialOwnerFlCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerFl thriftBeneficialOwnerFl,
    ...
    private static void beneficialOwnerOtherCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerOther thriftBeneficialOwnerOther,
    ...
    private static void beneficialOwnerForeignCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_beneficial_owner.BeneficialOwnerForeign thriftBeneficialOwnerForeign,
            BeneficialOwnerForeign swagBeneficialOwnerForeign) {
    ...
    private static void shareholdersCompare(
            dev.vality.questionary_proxy_aggr.kontur_focus_egr_details.ShareHolders thriftShareholders,
