...
public class DaDataCompareUtil {
    ...
    public static void fmsUnitCompare(
            dev.vality.questionary_proxy_aggr.dadata_fms_unit.FmsUnitContent thriftFmsUnitContent,
    ...
    public static void fioCompare(dev.vality.questionary_proxy_aggr.dadata_fio.FioContent thriftFioContent,
    ...
    public static void bankCompare(dev.vality.questionary_proxy_aggr.dadata_bank.BankContent thriftBankContent,
    ...
    public static void okvedCompare(dev.vality.questionary_proxy_aggr.dadata_okved2.OkvedContent thriftOkvedContent,
    ...
    public static void partyCompare(dev.vality.questionary_proxy_aggr.dadata_party.PartyContent thriftPartyContent,
        ...
        for (int i = 0; i < thriftPartyContent.getLicenses().size(); i++) {
            dev.vality.questionary_proxy_aggr.base_dadata.License license = thriftPartyContent.getLicenses().get(i);
        ...
        for (int i = 0; i < thriftPartyContent.getOkveds().size(); i++) {
            dev.vality.questionary_proxy_aggr.dadata_party.PartyOkved partyOkved =
    ...
    private static void opfCompare(dev.vality.questionary_proxy_aggr.base_dadata.Opf thriftOpf, Opf swagOpf) {
    ...
    private static void orgNameCompare(dev.vality.questionary_proxy_aggr.base_dadata.OrgName thriftOrgName,
                                       OrgName swagOrgName) {
    ...
    private static void daDataLicenseCompare(dev.vality.questionary_proxy_aggr.base_dadata.License thriftLicense,
    ...
    private static void authoritiesCompare(
            dev.vality.questionary_proxy_aggr.base_dadata.Authorities thriftAuthorities,
            dev.vality.swag.questionary_aggr_proxy.model.Authorities swagAuthorities) {
    ...
    public static void addressCompare(Address thriftAddress, DaDataAddress swagDaDataAddress) {
        ...
        for (int i = 0; i < thriftAddress.getMetroList().size(); i++) {
            dev.vality.questionary_proxy_aggr.dadata_address.AddressMetro addressMetro =
    ...
    private static void addressMetroCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressMetro thriftAddressMetro,
    ...
    private static void addressHouseCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressHouseData thriftHouse,
    ...
    private static void addressSettlement(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressSettlementData thriftSettlement,
    ...
    private static void addressRegionCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressRegionData thriftRegion,
    ...
    private static void addressFlatDataCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressFlatData thriftFlatData,
    ...
    private static void addressCityDistrictCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressCityDistrictData thriftCityDistrict,
    ...
    private static void addressBlockDataCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressBlockData thriftBlock,
    ...
    private static void addressCityDataCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressCityData thriftAddressCityData,
    ...
    private static void addressAreaDataCompare(
            dev.vality.questionary_proxy_aggr.dadata_address.AddressAreaData thriftAddressAreaData,
