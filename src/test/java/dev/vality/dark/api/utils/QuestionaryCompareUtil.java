...
public class QuestionaryCompareUtil {
    ...
    public static void contractorCompare(dev.vality.questionary.Contractor thriftContractor,
                                         Contractor swagContractor) {
        if (swagContractor instanceof IndividualEntityContractor) {
            dev.vality.questionary.RussianIndividualEntity thriftRussianIndividualEntity =
                    thriftContractor.getIndividualEntity().getRussianIndividualEntity();
            IndividualEntity swagIndividualEntity = ((IndividualEntityContractor) swagContractor).getIndividualEntity();
            Assert.assertEquals(thriftRussianIndividualEntity.getName(),
                    ((RussianIndividualEntity) swagIndividualEntity).getName());
            Assert.assertEquals(thriftRussianIndividualEntity.getInn(),
                    ((RussianIndividualEntity) swagIndividualEntity).getInn());
            Assert.assertEquals(thriftRussianIndividualEntity.getPdlRelationDegree(),
                    ((RussianIndividualEntity) swagIndividualEntity).getPdlRelationDegree());
            Assert.assertEquals(thriftRussianIndividualEntity.isPdlCategory(),
                    ((RussianIndividualEntity) swagIndividualEntity).isPdlCategory());
            Assert.assertEquals(thriftRussianIndividualEntity.isHasBeneficialOwners(),
                    ((RussianIndividualEntity) swagIndividualEntity).isHasBeneficialOwners());
            ...
            dev.vality.questionary.LegalEntity thriftLegalEntity = thriftContractor.getLegalEntity();
            LegalEntity swagLegalEntity = ((LegalEntityContractor) swagContractor).getLegalEntity();
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getInn(),
                    ((RussianLegalEntity) swagLegalEntity).getInn());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getAdditionalSpace(),
                    ((RussianLegalEntity) swagLegalEntity).getAdditionalSpace());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getForeignName(),
                    ((RussianLegalEntity) swagLegalEntity).getForeignName());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getLegalForm(),
                    ((RussianLegalEntity) swagLegalEntity).getLegalForm());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getName(),
                    ((RussianLegalEntity) swagLegalEntity).getName());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getOkatoCode(),
                    ((RussianLegalEntity) swagLegalEntity).getOkatoCode());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getOkpoCode(),
                    ((RussianLegalEntity) swagLegalEntity).getOkpoCode());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().getPostalAddress(),
                    ((RussianLegalEntity) swagLegalEntity).getPostalAddress());
            Assert.assertEquals(thriftLegalEntity.getRussianLegalEntity().isHasBeneficialOwners(),
                    ((RussianLegalEntity) swagLegalEntity).isHasBeneficialOwners());
            residencyInfoCompare(thriftLegalEntity.getRussianLegalEntity().getResidencyInfo(),
                    ((RussianLegalEntity) swagLegalEntity).getResidencyInfo());
            registrationInfoCompare(thriftLegalEntity.getRussianLegalEntity().getRegistrationInfo(),
                    ((RussianLegalEntity) swagLegalEntity).getRegistrationInfo());
            principalActivityCompare(thriftLegalEntity.getRussianLegalEntity().getPrincipalActivity(),
                    ((RussianLegalEntity) swagLegalEntity).getPrincipalActivity());
            for (int i = 0; i < thriftLegalEntity.getRussianLegalEntity().getBeneficialOwners().size(); i++) {
                dev.vality.questionary.BeneficialOwner beneficialOwner =
                        thriftLegalEntity.getRussianLegalEntity().getBeneficialOwners().get(i);
                BeneficialOwner swagBeneficialOwner =
                        ((RussianLegalEntity) swagLegalEntity).getBeneficialOwner().get(i);
                beneficialOwnerCompare(beneficialOwner, swagBeneficialOwner);
            }
            founderInfoCompare(thriftLegalEntity.getRussianLegalEntity().getFoundersInfo(),
                    ((RussianLegalEntity) swagLegalEntity).getFoundersInfo());
            ...
            additionalInfoCompare(thriftLegalEntity.getRussianLegalEntity().getAdditionalInfo(),
                    ((RussianLegalEntity) swagLegalEntity).getAdditionalInfo());
        }
    }

    private static void comparePropertyInfoDocType(
            dev.vality.questionary.PropertyInfoDocumentType thriftPropertyInfoDocumentType,
        ...
        } else if (swagPropertyInfoDocumentType.getDocumentType() ==
                PropertyInfoDocumentType.DocumentTypeEnum.SUBLEASECONTRACT) {
            Assert.assertTrue(thriftPropertyInfoDocumentType.isSetSubleaseContract());
        } else if (swagPropertyInfoDocumentType.getDocumentType() ==
                PropertyInfoDocumentType.DocumentTypeEnum.CERTIFICATEOFOWNERSHIP) {
            Assert.assertTrue(thriftPropertyInfoDocumentType.isSetCertificateOfOwnership());
        } else if (swagPropertyInfoDocumentType.getDocumentType() ==
                PropertyInfoDocumentType.DocumentTypeEnum.OTHERPROPERTYINFODOCUMENTTYPE) {
    ...
    private static void additionalInfoCompare(dev.vality.questionary.AdditionalInfo thriftAdditionalInfo,
                                              AdditionalInfo swagAdditionalInfo) {
        ...
        Assert.assertEquals(thriftAdditionalInfo.isHasLiquidationProcess(),
                swagAdditionalInfo.isHasLiquidationProcess());
        for (int i = 0; i < thriftAdditionalInfo.getFinancialPosition().size(); i++) {
            dev.vality.questionary.FinancialPosition thriftFinancialPosition =
                    thriftAdditionalInfo.getFinancialPosition().get(i);
        ...
        for (int i = 0; i < thriftAdditionalInfo.getBusinessInfo().size(); i++) {
            dev.vality.questionary.BusinessInfo thriftBusinessInfo = thriftAdditionalInfo.getBusinessInfo().get(i);
        ...
        compareBusinessReputation(thriftAdditionalInfo.getBusinessReputation(),
                swagAdditionalInfo.getBusinessReputation());
        compareAccountantInfo(thriftAdditionalInfo.getAccountantInfo(), swagAdditionalInfo.getAccountantInfo());
        compareMonthOperationSum(thriftAdditionalInfo.getMonthOperationSum(),
                swagAdditionalInfo.getMonthOperationSum());
    }

    private static void compareBusinessReputation(dev.vality.questionary.BusinessReputation thriftBusinessReputation,
                                                  BusinessReputation swagBusinessReputation) {
        if (swagBusinessReputation == BusinessReputation.NOREVIEWS) {
            Assert.assertSame(dev.vality.questionary.BusinessReputation.no_reviews, thriftBusinessReputation);
        } else if (swagBusinessReputation == BusinessReputation.PROVIDEREVIEWS) {
            Assert.assertSame(dev.vality.questionary.BusinessReputation.provide_reviews, thriftBusinessReputation);
        }
    }

    private static void compareBusinessInfo(dev.vality.questionary.BusinessInfo thriftBusinessInfo,
                                            BusinessInfo swagBusinessInfo) {
        if (swagBusinessInfo.getBusinessInfoType() == BusinessInfo.BusinessInfoTypeEnum.WHOLESALETRADEBUSINESS) {
        ...
        } else if (swagBusinessInfo.getBusinessInfoType() ==
                BusinessInfo.BusinessInfoTypeEnum.SECURITIESTRADINGBUSINESS) {
            ...
            Assert.assertTrue(thriftBusinessInfo.isSetProductionBusiness());
                ...
                BusinessInfo.BusinessInfoTypeEnum.MEDIATIONINPROPERTYBUSINESS) {
    ...
    private static void compareFinancialPosition(dev.vality.questionary.FinancialPosition thriftFinancialPosition,
                                                 FinancialPosition swagFinancialPosition) {
        if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.STATEMENTOFDUTY) {
            Assert.assertTrue(thriftFinancialPosition.isSetStatementOfDuty());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.QUARTERLYTAXRETURNWITHOUTMARK) {
            Assert.assertTrue(thriftFinancialPosition.isSetQuarterlyTaxReturnWithoutMark());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.QUARTERLYTAXRETURNWITHMARK) {
            Assert.assertTrue(thriftFinancialPosition.isSetQuarterlyTaxReturnWithMark());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.LETTEROFGUARANTEE) {
            Assert.assertTrue(thriftFinancialPosition.isSetLetterOfGuarantee());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.ANNUALTAXRETURNWITHOUTMARKPAPER) {
            Assert.assertTrue(thriftFinancialPosition.isSetAnnualTaxReturnWithoutMarkPaper());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.ANNUALTAXRETURNWITHMARK) {
            Assert.assertTrue(thriftFinancialPosition.isSetAnnualTaxReturnWithMark());
        } else if (swagFinancialPosition.getFinancialPositionType() ==
                FinancialPosition.FinancialPositionTypeEnum.ANNUALTAXRETURNWITHOUTMARK) {
    ...
    private static void compareMonthOperationSum(dev.vality.questionary.MonthOperationSum thriftMonthOperationSum,
                                                 MonthOperationSum swagMonthOperationSum) {
        if (swagMonthOperationSum == MonthOperationSum.BTWFIVEHUNDREDTHOUSANDTOONEMILLION) {
            Assert.assertSame(dev.vality.questionary.MonthOperationSum.btw_five_hundred_thousand_to_one_million,
                    thriftMonthOperationSum);
        } else if (swagMonthOperationSum == MonthOperationSum.GTONEMILLION) {
            Assert.assertSame(dev.vality.questionary.MonthOperationSum.gt_one_million, thriftMonthOperationSum);
        } else if (swagMonthOperationSum == MonthOperationSum.LTFIVEHUNDREDTHOUSAND) {
            Assert.assertSame(dev.vality.questionary.MonthOperationSum.lt_five_hundred_thousand,
                    thriftMonthOperationSum);
        }
    }

    private static void compareAccountantInfo(dev.vality.questionary.AccountantInfo thriftAccountantInfo,
                                              AccountantInfo swagAccountantInfo) {
        ...
        } else if (swagAccountantInfo.getAccountantInfoType() ==
                AccountantInfoTypeEnum.WITHOUTCHIEFINDIVIDUALACCOUNTANT) {
            Assert.assertTrue(thriftAccountantInfo.getWithoutChiefAccountant().isSetIndividualAccountant());
        } else if (swagAccountantInfo.getAccountantInfoType() ==
                AccountantInfoTypeEnum.WITHOUTCHIEFACCOUNTINGORGANIZATION) {
            Assert.assertTrue(thriftAccountantInfo.getWithoutChiefAccountant().isSetAccountingOrganization());
        }
    }

    public static void contactInfoCompare(dev.vality.questionary.ContactInfo thriftContactInfo,
    ...
    public static void bankAccountCompare(dev.vality.questionary.BankAccount thriftBankAccount,
                                          dev.vality.swag.questionary.model.BankAccount swagBankAccount) {
    ...
    private static void founderInfoCompare(dev.vality.questionary.FoundersInfo thriftFoundersInfo,
                                           FoundersInfo swagFoundersInfo) {
        ...
        for (int i = 0; i < thriftFoundersInfo.getHeads().size(); i++) {
            dev.vality.questionary.Head head = thriftFoundersInfo.getHeads().get(i);
        ...
        for (int i = 0; i < thriftFoundersInfo.getFounders().size(); i++) {
            dev.vality.questionary.Founder founder = thriftFoundersInfo.getFounders().get(i);
            Founder swagFounder = swagFoundersInfo.getFounders().get(i);
            founderCompare(founder, swagFounder);
        }
    }

    private static void founderCompare(dev.vality.questionary.Founder thriftFounder, Founder swagFounder) {
        if (swagFounder instanceof IndividualPerson) {
            Assert.assertEquals(thriftFounder.getIndividualPersonFounder().getInn(),
                    ((IndividualPerson) swagFounder).getInn());
            Assert.assertEquals(thriftFounder.getIndividualPersonFounder().getFio(),
                    ((IndividualPerson) swagFounder).getFio());
        } else if (swagFounder instanceof RussianLegalEntityFounder) {
            Assert.assertEquals(thriftFounder.getRussianLegalEntityFounder().getFullName(),
                    ((RussianLegalEntityFounder) swagFounder).getFullName());
            Assert.assertEquals(thriftFounder.getRussianLegalEntityFounder().getInn(),
                    ((RussianLegalEntityFounder) swagFounder).getInn());
            Assert.assertEquals(thriftFounder.getRussianLegalEntityFounder().getOgrn(),
                    ((RussianLegalEntityFounder) swagFounder).getOgrn());
        } else if (swagFounder instanceof InternationalLegalEntityFounder) {
            Assert.assertEquals(thriftFounder.getInternationalLegalEntityFounder().getCountry(),
                    ((InternationalLegalEntityFounder) swagFounder).getCountry());
            Assert.assertEquals(thriftFounder.getInternationalLegalEntityFounder().getFullName(),
                    ((InternationalLegalEntityFounder) swagFounder).getFullName());
        }
    }

    private static void headCompare(dev.vality.questionary.Head thriftLegalOwner, FounderHead swagLegalOwner) {
    ...
    private static void individualPersonCompare(dev.vality.questionary.IndividualPerson thriftIndividualPerson,
                                                IndividualPerson swagIndividualPerson) {
    ...
    private static void beneficialOwnerCompare(dev.vality.questionary.BeneficialOwner thriftBeneficialOwner,
                                               BeneficialOwner swagBeneficialOwner) {
        ...
        migrationCardInfoCompare(thriftBeneficialOwner.getMigrationCardInfo(),
                swagBeneficialOwner.getMigrationCardInfo());
        Assert.assertEquals(thriftBeneficialOwner.getOwnershipPercentage(),
                swagBeneficialOwner.getOwnershipPercentage().byteValue());
        residencyApproveCompare(thriftBeneficialOwner.getResidenceApprove(), swagBeneficialOwner.getResidenceApprove());
        russianPrivateEntityCompare(thriftBeneficialOwner.getRussianPrivateEntity(),
                swagBeneficialOwner.getRussianPrivateEntity());
    }

    private static void russianPrivateEntityCompare(
            dev.vality.questionary.RussianPrivateEntity thriftRussianPrivateEntity,
            RussianPrivateEntity swagRussianPrivateEntity) {
        ...
        Assert.assertEquals(thriftRussianPrivateEntity.getResidenceAddress(),
                swagRussianPrivateEntity.getResidenceAddress());
        Assert.assertEquals(thriftRussianPrivateEntity.getFio(), swagRussianPrivateEntity.getFio());
    }

    private static void residencyApproveCompare(dev.vality.questionary.ResidenceApprove thriftResidenceApprove,
                                                ResidenceApprove swagResidenceApprove) {
    ...
    private static void residencyInfoCompare(dev.vality.questionary.ResidencyInfo thriftResidencyInfo,
                                             ResidencyInfo swagResidencyInfo) {
    ...
    private static void registrationInfoCompare(dev.vality.questionary.RegistrationInfo thriftRegistrationInfo,
                                                RegistrationInfo swagRegistrationInfo) {
    ...
    private static void principalActivityCompare(dev.vality.questionary.Activity thriftPrincipalActivity,
                                                 Activity swagPrincipalActivity) {
    ...
    private static void migrationCardInfoCompare(dev.vality.questionary.MigrationCardInfo thriftMigrationCardInfo,
                                                 MigrationCardInfo swagMigrationCardInfo) {
    ...
    private static void licenseInfoCompare(dev.vality.questionary.LicenseInfo thriftLicenseInfo,
                                           LicenseInfo swagLicenseInfo) {
    ...
    private static void individualPersonCategoriesCompare(
            dev.vality.questionary.IndividualPersonCategories thriftIndividualPersonCategories,
            IndividualPersonCategories swagIndividualPersonCategories) {
        Assert.assertEquals(thriftIndividualPersonCategories.isBehalfOfForeign(),
                swagIndividualPersonCategories.isBehalfOfForeign());
        Assert.assertEquals(thriftIndividualPersonCategories.isBeneficialOwner(),
                swagIndividualPersonCategories.isBeneficialOwner());
        Assert.assertEquals(thriftIndividualPersonCategories.isForeignPublicPerson(),
                swagIndividualPersonCategories.isForeignPublicPerson());
        Assert.assertEquals(thriftIndividualPersonCategories.isForeignRelativePerson(),
                swagIndividualPersonCategories.isForeignRelativePerson());
        Assert.assertEquals(thriftIndividualPersonCategories.isHasRepresentative(),
                swagIndividualPersonCategories.isHasRepresentative());
        Assert.assertEquals(thriftIndividualPersonCategories.isWorldwideOrgPublicPerson(),
                swagIndividualPersonCategories.isWorldwideOrgPublicPerson());
    }

    private static void identityDocumentCompare(dev.vality.questionary.IdentityDocument thriftIdentityDocument,
                                                IdentityDocument swagIdentityDocument) {
    ...
    public static void internationalLegalEntityCompare(dev.vality.questionary.Contractor thriftContractor,
                                                       Contractor swagContractor) {
        ...
        dev.vality.questionary.InternationalLegalEntity internationalLegalEntity =
    ...
    public static void internationalBankAccountCompare(dev.vality.questionary.BankAccount thriftBankAccount,
                                                       dev.vality.swag.questionary.model.BankAccount swagBankAccount) {
        if (swagBankAccount instanceof InternationalBankAccount) {
            ...
            dev.vality.questionary.InternationalBankAccount thriftInternationalBankAccount;
            ...
            Assert.assertEquals(thriftInternationalBankAccount.getAccountHolder(),
                    internationalBankAccount.getAccountHolder());
